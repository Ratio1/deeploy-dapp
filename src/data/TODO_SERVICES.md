# Services observations and TODOs

## MISP deployment

Here is the ultra-short normal docker-compose:
...
services:
  ...
  misp:
    ...
    environment:
      - DATABASE_HOST=db
      # - DATABASE_PORT=some_automated_mysql_port
      - DATABASE_NAME=misp
      - DATABASE_USER=misp
      - DATABASE_PASSWORD=your_db_pass
      - REDIS_HOST=redis
      # - REDIS_PORT=some_automated_redis_port
      - MISP_BASEURL=https://your-domain
      - MISP_ADMIN_EMAIL=admin@your-domain
      - MISP_ADMIN_PASSPHRASE=your_gpg_pass
    depends_on:
      - db
      - redis
    volumes:
