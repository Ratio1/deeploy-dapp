...
const JOB_TYPE_STEPS: Record<JobType, Step[]> = {
    ...
    [JobType.Service]: [Step.SERVICES, ...MAIN_EDITING_STEPS, Step.REVIEW_AND_CONFIRM],
};
...
export default function JobEditFormWrapper({
    ...
    const getServiceSchemaDefaults = () => ({
        ...getBaseSchemaDefaults(),
        serviceId: 1, // TODO: Obtain serviceId (maybe through getRunningJobResources)
        specifications: {
            ...getBaseSchemaDefaults().specifications,
            serviceContainerType: serviceContainerTypes[0].name, // TODO: Implement after refactoring
        },
        deployment: {
            ...getBaseSchemaDefaults().deployment,
